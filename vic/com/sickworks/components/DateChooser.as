package com.sickworks.components 
{
	...
	public class DateChooser extends Sprite
	{
		...
		*/
		...
		{
			var day:String = (_dayLeadingZero && d.getUTCDate() < 9 ? "0" : "") + (d.getUTCDate() + 1).toString();
			var month:String = (_monthLeadingZero && d.getUTCMonth() < 9 ? "0" : "") + (d.getUTCMonth() + 1).toString();
			var year:String = d.getUTCFullYear().toString().substring(_fullYear ? 0 : 2);
			var ds:String;
